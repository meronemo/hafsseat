          ...
          <CardContent className="space-y-6">
            ...
            <div className="bg-muted/30 rounded-lg p-4">
              ...
              <div className="border-t border-border/50 pt-3">
                <div className="text-xs text-muted-foreground mb-1">학급</div>
                <div className="text-sm font-semibold">{displayClass}</div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div>
                <h3 className="text-sm font-medium mb-2 text-muted-foreground">일반</h3>
